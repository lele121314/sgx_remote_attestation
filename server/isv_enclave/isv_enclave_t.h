...
sgx_status_t rsa_public_key_gen(sgx_rsa3072_public_key_t* pub_key);
sgx_status_t rsa_verify(const uint8_t* p_data, uint32_t data_size, sgx_rsa3072_signature_t* p_signature, sgx_rsa_result_t* p_result, const sgx_rsa3072_public_key_t* p_public);
